...
namespace Project_10.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(RegisterViewModel model, [Bind(Include = "CustomerId,CustomerName,CustomerEmail,CityId")] Customer Customer )
        {
            Project10Entities db = new Project10Entities();
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (newUser != null)
                    {
                        var role = new AspNetUserRole { UserId = newUser.Id, RoleId = "2", userEmail = model.Email };
